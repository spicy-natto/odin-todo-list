...
class SidebarView {
  ...
  deselect() {
    const sidebarItemsDom = Array.from(
      this.sidebarList.getElementsByClassName("sidebar-item"),
    );
    sidebarItemsDom.forEach((item) =>
      item.classList.remove("sidebar-selected"),
    );
  }
